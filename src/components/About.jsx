  ...
  return (
    ...
    container mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden' id='About'>
      ...
      <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20'>
        ...
        <p className='my-10 max-w-lg'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Necessitatibus maxime, est cum mollitia
        atque itaque ex error beatae labore laudantium aliquid, aliquam repellendus. Possimus numquam nemo nam iste dicta? Eum.
        </p>
