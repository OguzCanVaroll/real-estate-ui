...
const Header = () => {
    return (
        ...
        items-center w-full overflow-hidden' style={{ backgroundImage: "url('/header_img.png')" }} id='Header'>
            ...
            lg:px-32 text-white'>
                <h2 className='text-5xl sm:text-6xl md:text-[82px] inline-block max-w-3x1
                font-semibold pt-20'>
                    Explore homes that fit your dreams
                </h2>
                <div className='space-x-6 mt-16'>
                    <a href='#Projects' className='border brder-white
                    px-8 py-3 rounded'>Projects</a>
                    <a href='#Contact' className='border brder-white bg-blue-500
